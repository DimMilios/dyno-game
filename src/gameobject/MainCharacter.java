...
public class MainCharacter {
	...
	public MainCharacter() {
		...
		normalRunAnim.addFrame(Resource.getResouceImage("src/data/main-character1.png"));
		normalRunAnim.addFrame(Resource.getResouceImage("src/data/main-character2.png"));
		jumping = Resource.getResouceImage("src/data/main-character3.png");
		downRunAnim = new Animation(90);
		downRunAnim.addFrame(Resource.getResouceImage("src/data/main-character5.png"));
		downRunAnim.addFrame(Resource.getResouceImage("src/data/main-character6.png"));
		deathImage = Resource.getResouceImage("src/data/main-character4.png");
...
//		g.drawRect(bound.x, bound.y, bound.width, bound.height);
	...
	public void dead(boolean isDeath) {
		state = isDeath ? DEATH : NORMAL_RUN;
	}
